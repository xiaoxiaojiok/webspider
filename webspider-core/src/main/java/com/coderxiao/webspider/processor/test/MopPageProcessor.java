...
public class MopPageProcessor implements PageProcessor {
	...
	public void process(Page page) {
		...
		List<String> list = page.getHtml()
				.links()
				.regex("http://dzh.mop.com/[0-9]+.html")
				.all();
		for (String url : list) {
	...
	public static void main(String[] args) {
		...
		Spider spider = Spider.create(new MopPageProcessor());
		spider.addPipeline(new HTMLPipeline("D:\\webmagic\\"))
		
				.addUrl("http://dzh.mop.com/")
				.scheduler(scheduler)
