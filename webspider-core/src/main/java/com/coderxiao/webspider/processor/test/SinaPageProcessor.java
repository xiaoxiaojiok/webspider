...
public class SinaPageProcessor implements PageProcessor {
	...
	public void process(Page page) {
		...
		List<String> list = page.getHtml()
				.links()
				.regex("http://[a-z]+.sina.com.cn/[a-z]/2015-04-[0-9]{2}/[0-9]{8,}.shtml")
				.all();
		for (String url : list) {
	...
	public static void main(String[] args) {
		...
		String[] urls = {"http://news.sina.com.cn/","http://edu.sina.com.cn","http://tech.sina.com.cn"};
		Spider spider = Spider.create(new SinaPageProcessor());
		spider.addPipeline(new HTMLPipeline("D:\\webmagic\\"))
		
				/*.addUrl("http://news.sina.com.cn/")
				.addUrl("http://edu.sina.com.cn")
				.addUrl("http://tech.sina.com.cn")*/
		        .addUrl(urls)
				.scheduler(scheduler)
